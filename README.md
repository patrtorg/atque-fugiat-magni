...
`tinycolor` can be installed from npm:
    ...
    npm install @patrtorg/atque-fugiat-magni

Then it can be used in your script like so:

```js
var tinycolor = require("@patrtorg/atque-fugiat-magni");
...
```js
import tinycolor from "@patrtorg/atque-fugiat-magni";
var color = tinycolor("red");
```
...
It can be used as a module by downloading [npm/esm/tinycolor.js](https://github.com/patrtorg/atque-fugiat-magni/blob/master/npm/esm/tinycolor.js) or using https://esm.sh/@patrtorg/atque-fugiat-magni.

```html
<script type='module'>
import tinycolor from "https://esm.sh/@patrtorg/atque-fugiat-magni";
var color = tinycolor("red");
</script>
```
...
You can use it directly in a script tag by downloading the UMD file from [npm/cjs/tinycolor.js](https://github.com/patrtorg/atque-fugiat-magni/blob/master/npm/cjs/tinycolor.js):
...
```
See [index.html](https://github.com/patrtorg/atque-fugiat-magni/blob/master/index.html) in the project for a demo.
